...
<div id="main">
  ...
  <label>
    ...
    <label for="mariée">
    <label>
      <input className="mariée" type="radio" name="yes,no,maybe"  required/>Mariée
     </label><br></br>
    </label>

    <label for="veuve">
    <label>
      <input className="mariée" type="radio" name="yes,no,maybe"  required/>veuve
     </label><br></br>
    </label>

    <label for="divorcée">
    <label>
      <input className="mariée" type="radio" name="yes,no,maybe"  required/>divorcée
     </label><br></br>
    </label>
