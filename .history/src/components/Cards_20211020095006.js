...
<div id="main">
  ...
  <section className="checkbox">
    ...
    <br></br>
    <label>
      <input type="checkbox" name="célibataire"   required/> célibataire
     </label><br></br>
    <label>
      <input className="a" name="" value="" type="checkbox">&nbsp;&nbsp;Vector</input>
    </label><br></br>
    <label>
  ...
  <label for="yes">
    <input className="yes" type="radio" name="yes,no,maybe" value="yes" ></input></label><br></br>
  <label for="no">
