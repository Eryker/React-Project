...
<div id="title">
	...
	<form id="Survey-form">
             ...
             <input id="name" class="area"  type="text" name="full name" value="" placeholder="" required>
             ...
             <input id="number" class="area" type="number" name="age" min="12" max="99" value="" placeholder="" required>
         <br>
         <br>		
