...
function Cards(props) {
    ...
    return (
        ...
        name = ""
        value = ""
        type = "checkbox" > & nbsp; & nbsp; 2 D Animation < /input> <
        /label><br></br >
        <
        label >
        <
        ...
        type = "checkbox"
        name = ""
        value = "" > & nbsp; & nbsp; 3 D animation < /input> <
        /label><br></br >
        <
        label >
        <
        ...
        type = "checkbox"
        name = ""
        value = "" > & nbsp; & nbsp; Stop motion < /input> <
        /label><br></br >
        <
        label >
        <
        ...
        type = "checkbox"
        name = ""
        value = "" > & nbsp; & nbsp; Motion graphics < /input> <
        /label><br></br >
        <
        /section> <
        br > < /br> <
        ...
        name = "yes,no,maybe"
        value = "yes"
        checked > & nbsp; & nbsp; yes < /input></label > < br > < /br> <
        label
        for = "no" >
        <
        input className = "no"
        type = "radio"
        name = "yes,no,maybe"
        value = "no" > & nbsp; & nbsp; no < /input></label > < br > < /br> <
        label
        for = "maybe" >
        <
        ...
        type = "radio"
        name = "yes,no,maybe"
        value = "maybe" > & nbsp; & nbsp; may be < /input></label > < br > < /br> <
        div className = "txtb" >
        <
        br > < /br> <
        br > < /br> <
