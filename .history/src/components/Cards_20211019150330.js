...
<div id="main">
 <div id="title">
	...
	<form id="Survey-form">
	    ...
	    <br></br>
		<br></br>
		<section classn="checkbox">
			<label>Which type of animation you love to watch?</label><br></br>
			<label>
			<input class="a" name="" value="" type="checkbox">&nbsp;&nbsp;2D Animation</input>
			</label><br></br>
			<label>
			<input class="b" type="checkbox"  name="" value="">&nbsp;&nbsp;3D animation</input>
			</label><br></br>
			<label>
			<input class="c" type="checkbox"  name="" value="">&nbsp;&nbsp;Vector</input>
			</label><br></br>
			<label>
			<input class="d" type="checkbox"  name="" value="">&nbsp;&nbsp;Stop motion</input>
			</label><br></br>
			<label>
			<input class="e" type="checkbox"  name="" value="">&nbsp;&nbsp;Motion graphics</input>
			</label><br></br>
			</section>
        <br></br>
		<br></br>
		...
		<label for="yes">
			<input class="yes" type="radio" name="yes,no,maybe" value="yes" checked>&nbsp;&nbsp;yes</input></label><br></br>
		<label for="no">
			<input   class="no" type="radio" name="yes,no,maybe" value="no">&nbsp;&nbsp;no</input></label><br></br>
		<label for="maybe" >
			<input  class="maybe" type="radio" name="yes,no,maybe" value="maybe">&nbsp;&nbsp;may be</input></label><br></br>
         <div class="txtb">
			 <br></br>
			 <br></br>
