...
<div id="main">
                            <div id="title">
                                ...
                                <form id="Survey-form">
                                    ...
                                    \	
                                    <p>what describes you the best:</p><br></br>
                                    <select id="dropdown">
                                    ...
                                    <p for="yes">
                                        <input className="yes" type="radio" name="yes,no,maybe" value="yes" checked>&nbsp;&nbsp;yes</input></p><br></br>
                                    <p for="no">
                                        <input   className="no" type="radio" name="yes,no,maybe" value="no">&nbsp;&nbsp;no</input></p><br></br>
                                    <p for="maybe" >
                                        <input  className="maybe" type="radio" name="yes,no,maybe" value="maybe">&nbsp;&nbsp;may be</input></p><br></br>
                                    <div className="txtb">
                                        <br></br>
                                        <br></br>
                                        <p>Any suggestions:</p>
