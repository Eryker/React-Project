...
<div id="main">
                            <div id="title">
                                ...
                                <input id="name" className="area" type="text" name="full name"  placeholder="" required></input>



                                
                                <span><input id="marie" className="area" type="checkbox" name="marie"  placeholder="" required/><label for="marie">marie</label></span><br></br>
