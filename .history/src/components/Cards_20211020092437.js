...
<div id="main">
                            <div id="title">
                                ...
                                <input id="name" className="area" type="text" name="Votre nom"  placeholder="Votre nom" required></input>
  ...
  <select id="dropdown">
    ...
    <option value="teacher">Salarié</option>
    <option value="professional">Cadre</option>
    <option value="businessman">Auto-entrepreneur</option>
    <option value="artist">artiste</option>
    <option value="artist">autre</option>
  </select>
  <br></br>
  <br></br>
  <br></br>
