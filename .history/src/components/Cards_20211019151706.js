                            ...
                            <div id="title">
                                ...
                                <form id="Survey-form">
                                    ...
                                    <section className="checkbox">
                                        ...
                                        <label>
                                        <input className="a" >2D Animation</input>
                                        </label><br></br>
                                        <label>
                                        <input className="b" >3D animation</input>
                                        </label><br></br>
                                        <label>
                                        <input className="c" >;Vector</input>
                                        </label><br></br>
                                        <label>
                                        <input className="d">top motion</input>
                                        </label><br></br>
                                        <label>
                                        <input className="e" >Motion graphics</input>
                                        </label><br></br>
                                        </section>
                                    <br></br>
                                    <br></br>
