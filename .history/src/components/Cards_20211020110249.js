...
<div id="main">
  ...
  <label>
    ...
    <label for="mariée">
    <label>
      <input className="yes" type="radio" name="yes,no,maybe"  required/>Mariée
     </label><br></br>
    </label><br></br>
    ...
    <label for="divorcée">
    <label>
      <input className="yes" type="radio" name="yes,no,maybe"  required/>Divorcée
     </label><br></br>
    </label><br></br>
  ...
  <select id="dropdown">
    ...
    <option value="salarié">2</option>
    <option value="cadre">3</option>
    <option value="auto-entrepreneur">4</option>
    <option value="artiste">5</option>
